...
(function () {
  ...
  var ocControls_prototype = function ocControls_prototype() {
  ...
  var ocControls = function ocControls(a, b, c, d, e, f, g, h) {
    var m = this,
        res;
    if (m instanceof ocControls) {
      ...
      if (m.__factoryClass) {
        ...
        if (typeof res == "function") {
          if (res._classInfo.name != ocControls._classInfo.name) return new res(a, b, c, d, e, f, g, h);
        } else {
          if (res) return res;
        }
      }
    ...
    } else return new ocControls(a, b, c, d, e, f, g, h);
  };
  // inheritance is here

  ocControls._classInfo = {
    name: "ocControls"
  };
  ocControls.prototype = new ocControls_prototype();

  (function () {
    if (typeof define !== "undefined" && define !== null && define.amd != null) {
      __amdDefs__["ocControls"] = ocControls;
      this.ocControls = ocControls;
    } else if (typeof module !== "undefined" && module !== null && module.exports != null) {
      module.exports["ocControls"] = ocControls;
    } else {
      this.ocControls = ocControls;
    }
