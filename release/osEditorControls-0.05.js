...
(function () {
  ...
  var osEditorControls_prototype = function osEditorControls_prototype() {
        ...
        _e().createClass("fileExplorer", {
          ...
          */
          ...
          activeFolder: function activeFolder(itemid) {
            ...
            this._lastActive = this._activeFolder;
          },
  ...
  var osEditorControls = function osEditorControls(a, b, c, d, e, f, g, h) {
    var m = this,
        res;
    if (m instanceof osEditorControls) {
      ...
      if (m.__factoryClass) {
        ...
        if (typeof res == "function") {
          if (res._classInfo.name != osEditorControls._classInfo.name) return new res(a, b, c, d, e, f, g, h);
        } else {
          if (res) return res;
        }
      }
    ...
    } else return new osEditorControls(a, b, c, d, e, f, g, h);
  };
  // inheritance is here

  osEditorControls._classInfo = {
    name: "osEditorControls"
  };
  osEditorControls.prototype = new osEditorControls_prototype();

  (function () {
    if (typeof define !== "undefined" && define !== null && define.amd != null) {
      __amdDefs__["osEditorControls"] = osEditorControls;
      this.osEditorControls = osEditorControls;
    } else if (typeof module !== "undefined" && module !== null && module.exports != null) {
      module.exports["osEditorControls"] = osEditorControls;
    } else {
      this.osEditorControls = osEditorControls;
    }
